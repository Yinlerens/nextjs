      ...
      formatter: p => {
        ...
        p.forEach(val => {
          ...
          <div class="flex items-center w-full h-[22px]">
            <span class="w-[5px] h-[5px] my-o mx-[2px] rounded-[50%]" style="background-color: ${
              val.color
            };"></span>
            <span class="text-xs text-[#03b8e2] scale-[0.8] my-0 mx-[2px]">${val.seriesName}</span>
            <span class="text-xs text-[#03b8e2] scale-[0.8] inline-block w-1/4">${
        ...
        let dom = `
                    <div class="box-border w-[206px] h-[103px] px-[20px] py-[5px] bg-[url('../public/images/contrast-bg.png')] bg-no-repeat bg-[length:100%_100%]">
                      <span class="inline-block mb-[2px] text-xs text-[#03b8e2] scale-90">${
                        p[0].dataIndex + 1
                      }月</span>
